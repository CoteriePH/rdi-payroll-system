            ...
            <ToAndIcon>
                ...
                <Icon>
                    ...
                    <BlueBell 
                        ...
                        xmlns="http://www.w3.org/2000/svg" 
                        viewBox="0 0 512 512">
                            <path fill="currentColor" d="M451.671 348.569L408 267.945V184c0-83.813-68.187-152-152-152s-152 68.187-152 152v83.945l-43.671 80.623A24 24 0 0 0 81.432 384h86.944a87.762 87.762 0 0 0-.376 8a88 88 0 0 0 176 0c0-2.7-.135-5.364-.376-8h86.944a24 24 0 0 0 21.1-35.431zM312 392a56 56 0 1 1-111.418-8h110.836a55.85 55.85 0 0 1 .582 8zM94.863 352L136 276.055V184a120 120 0 0 1 240 0v92.055L417.137 352z"/><path fill="currentColor" d="M240 112h32v136h-32z"/>
                    ...
                    <BubbleMessage
                        ...
                        xmlns="http://www.w3.org/2000/svg" 
                        viewBox="0 0 36 36">
                            <path class="clr-i-solid clr-i-solid-path-1" d="M18 2.5c-8.82 0-16 6.28-16 14s7.18 14 16 14a18 18 0 0 0 4.88-.68l5.53 3.52a1 1 0 0 0 1.54-.84v-6.73a13 13 0 0 0 4-9.27C34 8.78 26.82 2.5 18 2.5zm-1.07 6.63a1.41 1.41 0 1 1 2.81 0v9.77a1.41 1.41 0 1 1-2.81 0zm1.41 17.35a1.87 1.87 0 1 1 1.87-1.87a1.87 1.87 0 0 1-1.87 1.86z" fill="currentColor"/>
                    </BubbleMessage>
